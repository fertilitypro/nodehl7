...
(function (module, process, console) {
   ...
   * @property {Function} getSegmentAt
   * @property {Function} getSegments
   *
   * @property {Array<HL7Segment>} segments
  ...
  /**
 * @class HL7Segment
 * @property {String} typeofSegment
 * @property {Number} order
 * @property {Array<String>} parts
 * @property {Array<Object>} segmentsFields
 *
 * @property {Function} toMappedObject
 * @property {Function} get
 * @property {Function} set
 */
   ...
   *
   * @Class hl7Parser
   * @prop {HL7Message} HL7Message
   * @prop {HL7Segment} HL7Message
   */
  ...
  /**
   * @class hl7Parser
   * @prop {HL7Segment} HL7Segment
   * @prop {HL7Message} HL7Message
   */
  module.exports = hl7Parser;
  module.exports.HL7Segment = HL7Segment;
  module.exports.HL7Message = HL7Message;
